...
import { Skeleton, Card, Typography, Row, Col } from 'antd'
import { formatUserAddress, formatPhoneNumber, formatNumber, formatCpf } from '../util/stringUtil'
        ...
        <Row>
          ...
          <Col xs={24} xl={18}>
            ...
            <Row className="mb-lg">
              ...
              <UserField label="Telefone:" value={formatPhoneNumber(user.telefone)} />
              ...
              user.nomeResponsavel && (
                <>
                  ...
                  <UserField
                    ...
                    value={formatPhoneNumber(user.telefoneResponsavel)}
                  />
            ...
            <Row className="mb-lg">
              ...
              <UserField label="CPF:" value={formatCpf(user.cpf)} />
              <UserField
                label="Data de Nascimento:"
                value={new Date(user.dataNasc).toLocaleDateString('pt-br')}
              />
              <UserField label="Sexo:" value={user.sexo} />
              <UserField label="Peso:" value={`${formatNumber(user.peso)} kg`} />
              <UserField label="Altura:" value={`${formatNumber(user.altura)} cm`} />
